...
import { deriveProcessView } from "../client/src/lib/mes-utils";

describe("process upload aggregation", () => {
  it("builds process monitoring aggregates from uploaded daily and inspection rows", () => {
    ...
    expect(result.envScatter).toEqual([
      { humidity: 50, temperature: 25, total: 1, failRate: 0 },
      { humidity: 55, temperature: 25, total: 1, failRate: 100 },
